...
r = post_req(URL + vdc_uuid + "/external-network-services", {"params":{"external_network":"public"},"name":"E1","sequence_number":100})
ext_uuid = json.loads(r.text)["HAWK-DB"]["UUID"]

r = post_req(URL + vdc_uuid + "/nats", {"nat_static_address":"0.0.0.0","params":{"qos":"Default","default_gateway":"default","availability_option":"Default","max_instances_count":1,"begin_instances_count":1,"throughput":100,"throughputinc":100,"northbound":"E1"},"name":"NAT-1","nat_address_type":"dynamic","policy":{"sla_policy":"Default","sla":"Default"},"autoscale":{"ram_enabled":0,"compute_red":75,"ram_red":80,"compute_green":60,"ram_green":50,"throughput_green":60,"cooldown_remove":120,"cooldown_add":90,"compute_enabled":0,"throughput_red":80,"throughput_enabled":0},"pat_mode":"Disabled","sequence_number":100,"uuid":"b5467197-2a21-4ce6-9e66-99e6e1c06868"})
nat_uuid = json.loads(r.text)["HAWK-DB"]["UUID"]

r = post_req(URL + vdc_uuid + "/compute-services", {"uuid":"402b8f94-81ed-431f-9fc6-303d4f19ae5e","params":{"qos":"Default","default_gateway":"default","availability_option":"Default","max_instances_count":1,"begin_instances_count":1,"throughput":500,"northbound":"NAT-1"},"name":"Compute-1","serverfarm":["Cluster-1"],"policy":{"sla_policy":"Default","sla":"Default"},"user_data":"","sequence_number":100,"ssh_keys":[]})
