...
print "DEPROVISION NAT: " + deprovision(URL + "nats/" + nat_uuid)
print "DEPROVISION EXT: " + deprovision(URL + "external-networks/" + ext_uuid)
print "DEPROVISION COMPUTE: " + deprovision(URL + "compute-services/" + compute_uuid)
print "DEPROVISION SUBNET: " + deprovision(URL + "subnets/" + subnet_uuid)