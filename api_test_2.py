...
vdc_uuid = json.loads(r.text)["uuid"]
...
serverfarm_uuid = json.loads(r.text)["uuid"]
...
subnet_uuid = json.loads(r.text)["uuid"]
...
ext_uuid = json.loads(r.text)["uuid"]
...
nat_uuid = json.loads(r.text)["uuid"]
...
compute_uuid = json.loads(r.text)["uuid"]
