...
from mysql.connector.fabric import FabricMySQLServer, FabricShard
from mysql.connector.fabric.caching import FabricCache
from mysql.connector.fabric.balancing import WeightedRoundRobin
        ...
        try:
            ...
            try:
                if exc.code == 400:
                    ...
                    reason = exc.reason
                msg = "{reason} ({code})".format(
                    reason=reason, code=exc.code)
